    ...
    to-white to-85%">
        <div class="page-wrap grid grid-cols-1 md:grid-cols-2 gap-8 items-center pt-24 pb-12">
            ...
            <div class="pt-6 md:pt-0">
                ...
                <p class="font-serif-display text-xl text-mauve-500 mt-1">Bunga Meja</p>

                <img src="../img/bungameja.png" alt="Bunga Meja" class="mt-6 rounded-md shadow-lg w-56 md:w-64">
            </div>
