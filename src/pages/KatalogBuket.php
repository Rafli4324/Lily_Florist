    ...
    to-white to-85%">
        <div class="page-wrap grid grid-cols-1 md:grid-cols-2 gap-8 items-center pt-24 pb-12">
            ...
            <div class="pt-6 md:pt-0">
                ...
                <p class="font-serif-display text-xl text-mauve-500 mt-1">Buket Bunga</p>

                <img src="../img/buketbunga.png" alt="Buket" class="mt-6 rounded-md shadow-lg w-56 md:w-64">
            </div>
        ...
        <div class="p-5">
          <div class="flex gap-4">
            ...
            <div class="flex-1">
              ...
              <div class="mt-6">
                <button href="https://wa.me/6281234567890" id="orderBtn" class="w-32 mx-auto md:mx-0 block bg-[#8C6D73] text-white py-2 rounded-full hover:opacity-95">Pesan</button>
              </div>
            </div>
          </div>
        </div>
